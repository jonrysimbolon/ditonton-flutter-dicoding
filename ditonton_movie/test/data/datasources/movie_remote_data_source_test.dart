...
void main() {
  ...
  group('get movie detail', () {
    ...
    test('should return movie detail when the response code is 200', () async {
      ...
      when(
        mockHttpClient.get(
          Uri.parse('$tmdbBaseUrl/movie/$tId?api_key=$tmdbApiKey'),
        ),
      ).thenAnswer(
        (_) async =>
    ...
    test(
      ...
      () async {
        ...
        when(
          mockHttpClient.get(
            Uri.parse(
              '$tmdbBaseUrl/movie/$tId/recommendations?api_key=$tmdbApiKey',
            ),
          ),
        ).thenAnswer(
  ...
  group('search movies', () {
    ...
    test('should return list of movies when response code is 200', () async {
      ...
      when(
        mockHttpClient.get(
          Uri.parse(
            '$tmdbBaseUrl/search/movie?api_key=$tmdbApiKey&query=$tQuery',
          ),
        ),
      ).thenAnswer(
        (_) async => http.Response(
